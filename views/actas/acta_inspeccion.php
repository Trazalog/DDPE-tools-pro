    ...
    <div class="page_1" style="width: 100%;break-after:page">
        ...
        <div style="margin-bottom: 35px;width: 100%;">
            <div class="bodyActa" style="">
                ...
                siendo las <?php echo date('H'); ?> horas.  Los inspectores del S. V. I. S <span class="acta_inspectores"></span>, se constituyen en <span class="acta_puntoControl"></span> con domicilio en 
                 <span class="acta_puntoControlDomicilio"></span> propiedad de <span class="acta_propiedadDe"></span>. siendo atendidos por <span class="acta_quienAtendio"></span> D.N.I. N° <span class="acta_dniChofer"><?php echo $inspeccion->chof_id; ?></span> en su carácter de <span class="acta_caracter"></span>.<br>
                 Proceden a <span class="acta_procedenA"></span>, vehículo patente N° <span class="acta_patenteTractor"><?php echo $inspeccion->patente_tractor; ?></span>, N° de habilitación del SENASA <span class="acta_numSenasa"><?php echo $inspeccion->nro_senasa ?></span>, Documentación Sanitaria tipo <span class="acta_docSanitaria"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->tipo. ". ";} ?></span>
    ...
    <div class="page_1" style="width: 100%;break-after:page;">
        ...
        <div style="margin-bottom: 35px;width: 100%;">
            <div class="bodyActa" style="">
                ...
                En la ciudad de San Juan, Departamento <span class="acta_depto"></span>, Localidad <span class="acta_localidad"></span>, a los <?php echo date('d'); ?> días del mes de <?php echo $mes; ?> del año <?php echo date('Y'); ?>,
                siendo las <?php echo date('H'); ?> horas.  Los inspectores del S. V. I. S. <span class="acta_inspectores"></span>, se constituyen en <span class="acta_puntoControl"></span> con domicilio en 
                 <span class="acta_puntoControlDomicilio"></span> propiedad de <span class="acta_propiedadDe"></span>. Siendo atendidos por <span class="acta_quienAtendio"></span> D.N.I. N° <span class="acta_dniChofer"><?php echo $inspeccion->chof_id; ?></span> en su carácter de <span class="acta_caracter"></span>.
                 Proceden a <span class="acta_procedenA"></span>, vehículo patente N° <span class="acta_patenteTractor"><?php echo $inspeccion->patente_tractor; ?></span>, N° de habilitación del SENASA <span class="acta_numSenasa"><?php echo $inspeccion->nro_senasa ?></span>, Documentación Sanitaria tipo <span class="acta_docSanitaria"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->tipo. ". ";} ?></span>
