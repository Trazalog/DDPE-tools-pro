        ...
        <div style="margin-bottom: 35px;width: 100%;">
            <div class="bodyActa" style="">
                ...
                siendo las <span class="acta_horaInspeccion"><?php echo $horaInspeccion; ?></span> horas.  Los inspectores del S. V. I. S <span class="acta_inspectores"><?php echo $inspeccion->inspectores ?></span>, se constituyen en <span class="acta_puntoControl"><?php echo $inspeccion->se_constituye ?></span> con domicilio en 
                 ...
                 Proceden a <span class="acta_procedenA"><?php echo $inspeccion->proceden_a ?></span>, vehículo patente N° <span class="acta_patenteTractor"><?php echo $inspeccion->patente_tractor; ?></span>, N° de habilitación del SENASA <span class="acta_numSenasa"><?php foreach ($inspeccion->termicos->termico as $termico) { echo $termico->nro_senasa. "; ";} ?></span>, <?php if ($inspeccion->permisos_transito->permiso_transito) { ?> Documentación Sanitaria tipo <?php } ?><span class="acta_docSanitaria"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->tipo. ". ";} ?></span>
                 <?php if ($inspeccion->permisos_transito->permiso_transito) { ?>Establecimiento N° <?php } ?><span class="acta_origenNumeros"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->origen_num. "; ";} ?></span> <?php if ($inspeccion->permisos_transito->permiso_transito) { ?> nombre del Establecimiento de Origen <?php } ?><span class="acta_origenNombres"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->origen_nom. "; ";} ?></span> Transportista <span class="acta_transportista"><?php echo $transportista->razon_social ?></span>, teléfono del transportista 
                ...
                destinos <span class="acta_destinos"><?php foreach ($destinos as $destino) { echo $destino->razon_social. ", ". $destino->altura. ", ".$destino->calle. ", ". $destino->departamento. ". ";} ?></span> <?php if ($inspeccion->permisos_transito->permiso_transito) { ?>producto/s <?php } ?><span class="acta_productos"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->productos. " ";} ?></span>
                <?php if ($inspeccion->permisos_transito->permiso_transito) { ?>, temperatura <?php } ?><span class="acta_temperaturas"><?php foreach ($inspeccion->permisos_transito->permiso_transito as $permiso) { echo $permiso->temperatura. " ";} ?></span>, precintos <span class="acta_precintos"><?php foreach ($inspeccion->termicos->termico as $termico) { echo $termico->precintos. " ";} ?></span>, Peso Bruto <span class="acta_bruto"><?php echo $inspeccion->bruto ?></span>, 
