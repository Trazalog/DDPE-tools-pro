    ...
    <div class="page_1" style="width: 100%;break-after:page">
        ...
        <div style="margin-bottom: 35px;width: 100%;">
            <div class="bodyActa" style="">
                ...
                siendo las <span class="acta_horaInspeccion"><?php echo $horaInspeccionReprecintado; ?></span> horas.  Los inspectores del S. V. I. S <span class="acta_inspectores"><?php echo $inspeccion->inspectores_reprecintado ?></span>, se constituyen en <span class="acta_puntoControl"><?php echo $inspeccion->se_constituye ?></span> con domicilio en 
                 ...
                 Proceden a Reprecintar. Termico/s patente/s: </span><span class="acta_term_patente"><?php foreach ($inspeccion->termicos->termico as $termico) { echo $termico->patente. "; ";} ?></span>.</br>
                 ...
                 precintos <span class="acta_precintos"><?php if ($inspeccion->precinto_reprecintado) { echo $inspeccion->precinto_reprecintado. " ";} ?></span>, Peso Bruto <span class="acta_bruto"><?php echo $inspeccion->bruto_reprecintado ?></span>, 
                 Tara <span class="acta_tara"><?php echo $inspeccion->tara_reprecintado ?></span> kg, N° de Ticket <span class="acta_ticket"><?php echo $inspeccion->ticket_reprecintado ?></span>. Tipo de documentación <span class="acta_tpoDocumentacion"><?php echo $datosEscaneo['doc_impo']['descripcion']; ?></span>.
                 Observaciones: <span class="acta_observaciones"><?php echo $inspeccion->observaciones_reprecintado ?></span>.<br><br>
                </p>
            </div>
        </div>
