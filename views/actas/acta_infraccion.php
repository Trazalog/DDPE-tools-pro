        ...
        <div style="margin-bottom: 35px;width: 100%; float:left">
            <div class="bodyActa" style="">
                <div style="text-indent: 30px;">
                    ...
                    siendo las <span class="acta_hora"><?php echo $horaInfraccion ?></span> horas.  Los inspectores del S. V. I. S. <span class="acta_inspectores"><?php echo $inspeccion->inspectores ?></span>, se constituyen en <span class="acta_puntoControl"><?php echo $inspeccion->se_constituye ?></span> 
