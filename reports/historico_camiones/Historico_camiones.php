...
require  APPPATH . "/modules/".SICP. "/libraries/koolreport/core/autoload.php";
...
* @autor Hugo Gallardo
*/
class Historico_camiones extends \koolreport\KoolReport
{
    ...
    protected function settings()    {
				...
				log_message('INFO','#TRAZA|HISTORICOCAMIONES|SETTINGS >> ');
        $json = $this->params;
